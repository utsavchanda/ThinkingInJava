...
public class Lists {
    ...
    public static void basicTest(List<String> a){
        ...
        a.addAll(Countries.names(2));
        a.addAll(3, Countries.names(2));

        b = a.contains("1");
        b = a.containsAll(Countries.names(2));
    ...
    public static void testVisual(List<String> a){
        ...
        List<String> b = Countries.names(2);
    ...
    public static void main(String[] args) {
        ...
        iterMotion(new LinkedList<String>(Countries.names(3)));
        iterMotion(new LinkedList<String>(Countries.names(3)));
